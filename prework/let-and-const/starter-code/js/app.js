...
function displayPics(){
  ...
  // PUT YOUR RESPONSE IN THIS COMMENT : let declares variables that are limited to the scope of a block statement, or expression on which it is used, var  declares a variable globally regardless of block scope
  console.log(viewed);
