...
function displayPics(){
  ...
  // PUT YOUR RESPONSE IN THIS COMMENT : because var defined the variable everywhere but let only inside the function so when we change it from var to let we have an error
  console.log(viewed);
