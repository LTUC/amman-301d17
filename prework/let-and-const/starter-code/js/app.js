...
function displayPics(){
  ...
  // const statement declares a block-scoped local variables,that are undefined out of that scope (out of while scope in this case).
  // unlike var, where the scope of the variable is the entire function regardless the scope
