...
function displayPics(){
  ...
  // Because the console is out the function and when use const we cant console log rando out off the function because const make the thing inside the function only.
  console.log(viewed);
...
if(localStorage.busmall){
  ...
  this.all.Products = JSON.parse(localStorage.busmall);
} else {
