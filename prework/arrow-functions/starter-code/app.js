...
// it refers the object joe that was constructed by the constructor function Student which includes {name: "Joe", age: 100, hometown: "Schmoe"}.
// 2. What is "this" when joe.scopeArrow() is invoked?
// it refers to the global scope window object because arrow functions don't have their own this.
// 3. Explain why "this" is different when an arrow function is used.
// arrow functions uses the surrounding scope as the scope of this which is the window object.
